  ...
  if (count($result) != 0){
    ...
    for ($i=0; $i < count($result); $i++){
      if ($rowcount > $first && $rowcount <= $last) {
        ...
        if (strlen($result[$i][3]) > $skin_titlelimit){ $mg2->title = substr($result[$i][3],0,$skin_titlelimit) . "...";
...
?>
  ...
  <tr>
    <td colspan="100">
	  <br />
	  <div class="credits">Powered by <a href="http://www.minigal.dk" target="_blank">MG2</a> v<?php echo $mg2->version ?></div>
	</td>
<?
}
